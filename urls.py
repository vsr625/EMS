...
urlpatterns = [
    ...
    url(r'^dashboard_a/update_event/(?P<event_id>[a-f0-9]{8}-?[a-f0-9]{4}-?4[a-f0-9]{3}-?[89ab][a-f0-9]{3}-?[a-f0-9]{12})', views.update_event, name='update_event'),
    url(r'^dashboard_a/delete_event/(?P<event_id>[a-f0-9]{8}-?[a-f0-9]{4}-?4[a-f0-9]{3}-?[89ab][a-f0-9]{3}-?[a-f0-9]{12})', views.delete_event, name='delete_event'),
    url(r'^dashboard_a/view_event/(?P<event_id>[a-f0-9]{8}-?[a-f0-9]{4}-?4[a-f0-9]{3}-?[89ab][a-f0-9]{3}-?[a-f0-9]{12})', views.view_event, name='view_event'),
    ...
    url(r'^dashboard_c/update_winner/(?P<event_id>[a-f0-9]{8}-?[a-f0-9]{4}-?4[a-f0-9]{3}-?[89ab][a-f0-9]{3}-?[a-f0-9]{12})',
